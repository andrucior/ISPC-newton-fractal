...
extern "C" {
#endif // __cplusplus
    extern void computeRoots(int32_t n, float * rootsRe, float * rootsIm);
    extern void renderNewtonFractal(int32_t width, int32_t height, int32_t n, float * rootsRe, float * rootsIm, int32_t maxIterations, float eps, uint8_t * image);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
